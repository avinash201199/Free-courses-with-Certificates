  ...
  technology: [
...

    {
      ...
      course: [
        ...
        {
          website_name: "Cisco Networking Academy",
          Course_description: "PCAP: Programming Essentials in Python",
...
course_details.technology.forEach((tech, index) => {
  ...
  technologyTemplate += `<div>
    <p>
        <a class="btn btn-primary" data-bs-toggle="collapse" href="#multiCollapse_${
          index + 1
        }" role="button"
            aria-expanded="false" aria-controls="multiCollapse_${
              index + 1
            }">${technologyTitle}</a>
    </p>
    <div id=course_${
      index + 1
    } style="margin: 5px 20px 5px 20px">${courseTemplate}</dix>
</div>`;
});
